...
const TaskCard = (props) => {
    ...
    return (<div onClick={props.onClick} id={props.taskName + props.taskCorP + props.taskPriority + props.taskLevel + props.taskDay} 
    ...
    my-3 p-3">
        <div className="flex">
            ...
            <Button 
            id={props.taskName + props.taskCorP + props.taskPriority + props.taskLevel + props.taskDay} 
